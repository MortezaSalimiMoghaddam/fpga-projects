...
HD_PWD='D:/projects/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bcdToBinary.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bcdToBinary.tcl -notrace
