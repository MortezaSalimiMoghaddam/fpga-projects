...
HD_PWD='D:/projects/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcdToBinary.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcdToBinary.tcl
