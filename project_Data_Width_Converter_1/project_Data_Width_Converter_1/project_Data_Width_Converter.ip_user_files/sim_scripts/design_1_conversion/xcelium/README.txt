...
#
# Generated by export_simulation on Thu Aug 24 01:28:50 +0330 2023
#
################################################################################
...
'-reset_run' switch to the './design_1_conversion.sh' script.

./design_1_conversion.sh -reset_run
...
./design_1_conversion.sh -noclean_files

For more information on the script, please type './design_1_conversion.sh -help'.
