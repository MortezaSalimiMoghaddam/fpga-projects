...
entity design_1_conversion is
  ...
  attribute CORE_GENERATION_INFO of design_1_conversion : entity is "design_1_conversion,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1_conversion,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of design_1_conversion is
  ...
  component design_1_conversion_xlconstant_0_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component design_1_conversion_xlconstant_0_0;
...
xlconstant_0: component design_1_conversion_xlconstant_0_0
     port map (
